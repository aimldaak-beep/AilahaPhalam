    ...
    <div style={{
      ...
      <div id="cum-lifetime-offset" className="relative overflow-hidden flex flex-wrap items-center justify-between gap-4" style={{ background: 'rgba(255,255,255,0.03)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(201,168,76,0.15)', borderRadius: 16, padding: '20px 24px', width: '100%', marginTop: 20 }}>
        ...
        <div className="text-right">
          ...
          <span className="block text-[13px] font-mono mt-1 uppercase tracking-wider" style={{ color: 'rgba(240,230,200,0.5)' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" style={{ marginTop: 16 }}>
        <div className="flex items-center justify-between text-xs" style={{ background: 'rgba(255,255,255,0.03)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(201,168,76,0.15)', borderRadius: 16, padding: '20px 24px' }}>
          ...
          <span className="font-bold font-mono text-base px-3 py-1.5" style={{ color: '#F0E6C8', background: 'rgba(0,0,0,0.2)', border: '1px solid rgba(201,168,76,0.1)', borderRadius: 12 }}>
        ...
        <div className="flex items-center justify-between text-xs" style={{ background: 'rgba(255,255,255,0.03)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(201,168,76,0.15)', borderRadius: 16, padding: '20px 24px' }}>
          ...
          <span className="font-extrabold font-mono text-base px-3 py-1.5" style={{ color: '#C9A84C', background: 'rgba(201,168,76,0.08)', border: '1px solid rgba(201,168,76,0.2)', borderRadius: 12 }}>
        ...
        <div className="flex items-center justify-between text-xs" style={{ background: 'rgba(255,255,255,0.03)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(201,168,76,0.15)', borderRadius: 16, padding: '20px 24px' }}>
          ...
          <span className="font-extrabold font-mono text-base px-3 py-1.5" style={{ color: '#C9960C', background: 'rgba(201,150,12,0.1)', border: '1px solid rgba(201,150,12,0.2)', borderRadius: 12 }}>
