              ...
              <tbody style={{ color: 'rgba(240,230,200,0.7)' }}>
                {matchedTrades.slice(0, 5).map(t => (
                  <tr key={t.id} className="transition duration-150" style={{ borderBottom: '1px solid rgba(201,168,76,0.06)' }}>
                    <td className="py-2.5 px-4" style={{ color: '#F0E6C8', fontSize: 18, fontWeight: 700 }}>{t.symbol}</td>
                    <td className="py-2.5 px-4" style={{ fontSize: 15 }}>{t.instrument}</td>
                    ...
                    <td className="py-2.5 px-4 font-mono" style={{ color: 'rgba(240,230,200,0.45)', fontSize: 15 }}>{t.dateInitiated}</td>
                    <td className="py-2.5 px-4 text-right font-bold font-mono" style={{ color: '#F0E6C8', fontSize: 17 }}>
                      {t.currency === 'INR' ? '₹' : '$'}
