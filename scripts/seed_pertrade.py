#!/usr/bin/env python3
"""Seed one throwaway allowlisted user for the per-trade-FX + weekly-journal smoke.
...
email = f'smoke-pt-{random.randint(1,10**9)}@example.com'
...
post(f'{SB}/rest/v1/trades', [{'user_id': uid, 'data': d} for d in (dow, nif, nas)], pref='return=minimal')
